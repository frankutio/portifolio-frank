...
INSERT INTO `usuario` VALUES (1,1,'frankutio','Frank Bezerra Simião','fb007032','frankutio@gmail.com','/img/perfil/frank.jpg','<p>Meu nome &eacute; <strong>Frank Bezerra</strong>, sou <strong>Desenvolvedor de interfaces Web</strong> no P<span style=\"text-decoration: underline;\">ortal Medicando</span>, especializado em Design-web, crio interfaces e templates para portais seguindo os padr&otilde;es de web standards e acessibilidade.</p>','1986-01-30','false','true'),(2,2,'juju.juju','Juliana','12345678','juju@email.com',NULL,NULL,'1984-01-30','false','false');
