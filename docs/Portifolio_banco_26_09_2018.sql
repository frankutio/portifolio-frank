...
CREATE DATABASE `portifolio` CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `portifolio`;
...
INSERT INTO `usuario` VALUES (1,1,'frankutio','Frank Bezerra Simião','fb007032','frankutio@gmail.com','/img/perfil/1/frank.jpg','<p>Meu nome &eacute;&nbsp;<strong>Frank Bezerra</strong>, sou&nbsp;Desenvolvedor de interfaces Web&nbsp;no portal&nbsp;<span style=\"text-decoration: underline;\"><em>Medicando</em></span>, especializado em Design-web, crio interfaces e templates para portais seguindo os padr&otilde;es de web standards e acessibilidade.</p>','1984-01-30','false','true'),(2,2,'juju.teste','Juliana Aragão','12345678','juju@email.com','img/perfil/2/img-frank.png','<p>Esse &eacute; meu 1&ordm; Crud!&nbsp;<img src=\"js/lib/new_tiny/plugins/emoticons/img/smiley-kiss.gif\" alt=\"kiss\" /></p>','1984-01-30','false','false');
...
-- Dump completed on 2018-09-26 15:30:53
